...
-- at runtime using the environment variable circuits_parser_bindir.
...
-- environment variable circuits_parser_libdir.
...
-- using the environment variable circuits_parser_dynlibdir.
...
-- runtime using the environment variable circuits_parser_datadir.
...
-- variable circuits_parser_libexedir.
...
-- using the environment variable circuits_parser_sysconfdir.
...
libdir     = "/Users/tonyday567/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf/circuits-parser-0.1.0.0-inplace-test-alt"
dynlibdir  = "/Users/tonyday567/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf"
datadir    = "/Users/tonyday567/.cabal/share/aarch64-osx-ghc-9.14.1-bcbf/circuits-parser-0.1.0.0"
libexecdir = "/Users/tonyday567/.cabal/libexec/aarch64-osx-ghc-9.14.1-bcbf/circuits-parser-0.1.0.0"
sysconfdir = "/Users/tonyday567/.cabal/etc"

getBinDir     = catchIO (getEnv "circuits_parser_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "circuits_parser_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "circuits_parser_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "circuits_parser_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "circuits_parser_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "circuits_parser_sysconfdir") (\_ -> return sysconfdir)
